...
def show_ninja(color):
  print color
  if color == "blue":
    return render_template("turtle.html", turtle  = "leonardo")
  elif color == "orange":
    return render_template("turtle.html", turtle  = "michelangelo" )
  elif color == "red":
    return render_template("turtle.html", turtle  = "raphael")
  elif color == "purple":
    return render_template("turtle.html", turtle  = "donatello")
  else:
    return render_template("turtle.html", turtle  = "notapril" )
